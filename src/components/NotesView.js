...
class NotesView extends React.Component {
      ...
      render() {
        ...
        let ret = slots.map((o, i) => {
          ...
          return (<div key={'slot'+i} className={p + ' incontext'} style={{ float:'left', width: '1.5em'}}><div style={{fontSize:'50%'}} className='circle'></div><div className={'small'} style={{marginTop:'-0.025em'}}>{o.note}</div></div>)
        })
